...
RSpec.describe Semverify::IncrementableSemver do
  ...
  describe '#next_major' do
    ...
    context 'when the version does not have pre_release or build_metadata parts' do
      context 'when neither pre nor build_metadata args were given' do
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('2.0.0') }
        it { is_expected.to be_a(described_class) }
      ...
      context 'when arg pre: true is given' do
        let(:args) { { pre: true } }
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('2.0.0-pre.1') }
      ...
      context "when args pre: true, pre_suffix: 'alpha' are given" do
        ...
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('2.0.0-alpha.1') }
    ...
    context 'when the version has a build metadata part' do
      context 'when build_metadata is not given' do
        ...
        let(:expected_version) { Semverify::IncrementableSemver.new('2.0.0+ARM64') }
      ...
      context 'when non-blank build_metadata is given' do
        ...
        let(:expected_version) { Semverify::IncrementableSemver.new('2.0.0+new') }
  ...
  describe '#next_minor' do
    ...
    context 'when the version does not have pre_release or build_metadata parts' do
      context 'when neither pre nor build_metadata args were given' do
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.3.0') }
        it { is_expected.to be_a(described_class) }
        it { is_expected.to eq(expected_version) }
      end
      ...
      context 'when arg pre: true is given' do
        let(:args) { { pre: true } }
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.3.0-pre.1') }
      ...
      context "when args pre: true, pre_suffix: 'alpha' are given" do
        let(:args) { { pre: true, pre_type: 'alpha' } }
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.3.0-alpha.1') }
    ...
    context 'when the version has a build metadata part' do
      context 'when build_metadata is not given' do
        let(:version) { '1.2.3+ARM64' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.3.0+ARM64') }
      ...
      context 'when non-blank build_metadata is given' do
        let(:args) { { build_metadata: 'new' } }
        let(:version) { '1.2.3+old' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.3.0+new') }
    ...
    context "when the version has a pre_release part 'beta.1'" do
      ...
      context 'when no args are given' do
        it 'should increment the pre-release part to "beta.2"' do
          expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3-beta.2'))
        end
      end
      ...
      context 'when pre_type arg is given' do
        ...
        context "when the arg { pre_type: 'rc' } is given" do
          ...
          it "should increment the pre-release part to 'rc.1'" do
            expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3-rc.1'))
          end
        end
        ...
        context 'when the version has a build metadata part' do
          ...
          context 'when build_metadata arg is not given' do
            it 'should increment the pre_release part and preserve the build_metadata part' do
              expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3-beta.2+AMD64'))
            end
          end
          ...
          context "when the arg { build_metadata: '386' } is given" do
            ...
            it 'should increment the pre_release part and replace the build_metadata part' do
              expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3-beta.2+386'))
            end
          end
        end
      end
  ...
  describe '#next_patch' do
    ...
    context 'when the version does not have pre_release or build_metadata parts' do
      context 'when neither pre nor build_metadata args were given' do
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.2.4') }
        it { is_expected.to be_a(described_class) }
        it { is_expected.to eq(expected_version) }
      end
      ...
      context 'when arg pre: true is given' do
        let(:args) { { pre: true } }
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.2.4-pre.1') }
      ...
      context "when args pre: true, pre_suffix: 'alpha' are given" do
        let(:args) { { pre: true, pre_type: 'alpha' } }
        let(:version) { '1.2.3' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.2.4-alpha.1') }
    ...
    context 'when the version has a build metadata part' do
      context 'when build_metadata is not given' do
        let(:version) { '1.2.3+ARM64' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.2.4+ARM64') }
      ...
      context 'when non-blank build_metadata is given' do
        let(:args) { { build_metadata: 'new' } }
        let(:version) { '1.2.3+old' }
        let(:expected_version) { Semverify::IncrementableSemver.new('1.2.4+new') }
  ...
  describe '#next_release' do
    ...
    context 'when the version is a pre-release version' do
      ...
      it 'should return a non-pre-release version' do
        expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3'))
      end
      ...
      context 'when the version does not include a build_metadata part' do
        context 'when the arg build_metadata: "AMD64" is given' do
          ...
          it "should return a non-pre-release version with the build_metadata set to 'AMD64'" do
            expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3+AMD64'))
          end
        end
      end
      ...
      context "when the version includes a build_metadata part '123456'" do
        ...
        context 'when no args are given' do
          it 'should return a non-pre-release version with the build_metadata preserved' do
            expect(subject).to eq(Semverify::IncrementableSemver.new('1.2.3+123456'))
          end
        end
