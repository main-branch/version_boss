...
RSpec.describe Semverify::Gem::VersionFileFactory do
  describe '.find' do
    ...
    context 'for a VERSION file' do
      ...
      it { is_expected.to be_a(Semverify::Gem::VersionFile) }
      ...
      it do
        is_expected.to(
          have_attributes(
            path: 'VERSION',
            content_before: '',
            version: Semverify::Gem::IncrementableVersion.new('1.2.3.pre.1'),
            content_after: ''
          )
        )
      end
      ...
      it do
        is_expected.to(
          have_attributes(
            ...
            version: Semverify::Gem::IncrementableVersion.new('0.1.0'),
            content_after: "'\nend\n"
          )
        )
      end
      ...
      it do
        is_expected.to(
          have_attributes(
            ...
            version: Semverify::Gem::IncrementableVersion.new('2.0.0.pre.1'),
            content_after: "'\nend\n"
          )
        )
      end
