...
RSpec.describe Semverify::Gem::VersionFile do
  ...
  let(:version) { Semverify::Gem::IncrementableVersion.new('1.2.3') }
  ...
  describe '#version=' do
    let(:new_version) { Semverify::Gem::IncrementableVersion.new('9.9.9') }
