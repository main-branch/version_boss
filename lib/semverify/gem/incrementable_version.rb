...
module Semverify
  module Gem
    ...
    class IncrementableVersion < Version
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3').next_major # =>
      #     Semverify::IncrementableVersion.new('2.0.0')
      #
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3').next_minor # =>
      #     Semverify::IncrementableVersion.new('1.3.0')
      #
      # @return [IncrementableVersion] a new IncrementableVersion object with the major version incremented
      #
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3').next_patch # =>
      #     Semverify::IncrementableVersion.new('1.2.1')
      #
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3.pre.1').next_patch.to_s # => '1.2.3.pre.2'
      #
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3.pre.1').next_release.to_s # => '1.2.3'
      #
      ...
      #
      # @example
      #   Semverify::IncrementableVersion.new('1.2.3.pre.1').pre_type # => 'pre'
      #
      # @return [String]
      #
      def pre_type
