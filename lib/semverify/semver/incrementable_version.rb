...
module Semverify
  module Semver
    ...
    class IncrementableVersion < Version
      ...
      #   IncrementableVersion.new('1.2.3-alpha').valid? # => raise Semverify::Error
      #   IncrementableVersion.new('1.2.3-alpha.1.2').valid? # => raise Semverify::Error
      #   IncrementableVersion.new('1.2.3-alpha.one').valid? # => raise Semverify::Error
      #
